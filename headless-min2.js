...
(function (cb) {
  ...
  function Ca(a, b) {
    ...
    this.Df = b;
    this.sb = a;
    this.Jc = window.performance.now()
  }
  function Da() {
  }
  function Ia() {
  ...
  function Fa(a) {
    ...
    this.jh = 1;
    this.Pe = 0;
    this.yf = window.performance.now();
  ...
  function Na(a) {
    ...
    this.Ob = a.Ob;
    this.fb = a.fb;
    this.Bf = window.performance.now();
    var c = null,
      c = function () {
        var a = b.Dh - b.Xh();
        0 >= a ? b.bb() : (window.clearTimeout(b.Cf), a = window.setTimeout(c, a + 1000), b.Cf = a)
      };
    c();
    ...
    for (var d = this.hb; a < d.length;) {
      ...
      e.onmessage = function (a) {
        b.Ec && (b.Bf = window.performance.now(), null != b.$e && b.$e(a.data))
      };
      e.onclose = function () {
        b.bb()
      }
  ...
  function wa(a, b, c) {
    ...
    this.ra.onicecandidate = function (a) {
      null == a.candidate ? d.Qg(d.zd) : (a = a.candidate, null !=
        a.candidate && '' != a.candidate && (null != d.Hd && d.Hd(a), d.zd.push(a)))
    };
  ...
  wa.prototype = {
    Uh: function (a) {
      null == a && (a = 10000);
      window.clearTimeout(this.Ud);
      this.Ud = window.setTimeout(Ua(this, this.Pg), a)
    },
    rg: function (a, b) {
      var c = this;
      this.wg(this.ra.setRemoteDescription(a).then(function () {
    ...
    sg: function (a) {
      ...
      a.onopen = function () {
        for (var a = 0, c = b.hb; a < c.length;) if ('open' != c[a++].readyState) return;
        null != b.Fd && b.Fd()
      };
      a.onclose = function () {
        b.Cc()
  ...
  fa.prototype = {
    Qd: function (a) {
      ...
      if (null != this.Ya || null != a) {
        if (null != this.Ya && null != a && this.Ya.byteLength == a.byteLength) {
          for (var c = new Uint8Array(this.Ya), d = new Uint8Array(a), e = !1, f = 0, h = this.Ya.byteLength; f < h;) {
            var m = f++;
            if (c[m] != d[m]) {
              e = !0;
              break
        ...
        this.Ya = a.slice(0);
        this.Yc = !0;
        null != this.ta && 1 == this.ta.readyState && null == this.Zc && (this.Nd(), this.Zc = window.setTimeout(function () {
          b.Zc = null;
    ...
    Pd: function (a) {
      ...
      var c = this;
      this.dc = a;
      null == this.mf && (b(), this.mf = window.setTimeout(b, 1000))
    },
    Rd: function (a) {
      function b(a) {
        a = a.sitekey;
        if (null == a) throw new l(null);
        null != d.$b && d.$b(a, function (a) {
          d.Rd(a)
        })
      }
      function c(a) {
        ...
        d.ta.onclose = function (a) {
          d.xd(4001 != a.code)
        };
        d.ta.onerror = function () {
          d.xd(!0)
        };
        d.ta.onmessage = Ua(d, d.Ng)
      }
      null == a && (a = '');
      var d = this;
      F.vh(this.Rh, 'token=' + this.$c + '&rcr=' + a, F.Uf).then(function (a) {
        switch (a.action) {
          case 'connect':
            c(a);
            break;
    ...
    Og: function () {
      ...
      0 != this.dc && this.qf();
      this.qh = window.setInterval(function () {
        a.Lh()
      }, 40000)
    },
    Ng: function (a) {
      a = new C(new DataView(a.data), !1);
      switch (a.B()) {
        case 1:
          this.Lg(a);
          break;
    ...
    Lg: function (a) {
      ...
      try {
        ...
        e = a.kb();
        for (var h = a.jf(), m = [
        ], q = 0; q < h.length;) m.push(new RTCIceCandidate(h[q++]));
        f = m
      } catch (ib) {
        this.fc(b, 0);
        return
    ...
    Mg: function (a, b, c, d, e, f) {
      ...
      if (16 <= this.vb.size) this.fc(a, 4104);
        ...
        if (null != this.Be && (q = new C(e.j), q.a = e.a, e = this.Be(b, q), 1 == e.yd)) {
          this.fc(a, e.reason);
          return
        }
        ...
        k.Uh();
        k.rg(new RTCSessionDescription({
          sdp: c,
          type: 'offer'
        }), d)
      }
    ...
    xd: function (a) {
      var b = this;
      this.xg();
      window.clearTimeout(this.Zc);
      this.Zc = null;
      this.Yc = !1;
      window.clearInterval(this.qh);
      window.clearTimeout(this.Hh);
      a && (this.Hh = window.setTimeout(function () {
        b.Rd()
  ...
  Na.prototype = {
    Xh: function () {
      return window.performance.now() - this.Bf
    },
    mb: function (a, b) {
      if (this.Ec) {
        var c = this.hb[a];
        if ('open' == c.readyState) {
          ...
          try {
            ...
            window.console.log(e instanceof l ? e.Db : e)
          }
        }
      }
    },
    bb: function () {
      ...
      this.Ec && (this.Ec = !1, this.ra.close(), null != this.Ze && this.Ze())
    },
    h: Na
  };
  C.b = !0;
  C.ug = function (a, b) {
    ...
    if (0 == (c & 128)) ++b;
      ...
      b += 6;
    else throw new l('Cannot decode UTF8 character at offset ' + b + ': charCode (' + c + ') is invalid');
    return {
      'char': c,
      length: b - q
    }
  ...
  C.prototype = {
    ...
    lb: function () {
      for (var a = this.a, b = 0, c, d = 0; c = this.j.getUint8(a + b), 5 > b && (d |= (c & 127) << 7 * b >>> 0), ++b, 0 != (c & 128););
      this.a += b;
      return d | 0
    },
    Uc: function (a) {
      var b = this.a,
        c,
        d = '';
      for (a = b + a; b < a;) c = C.ug(this.j, b),
        b += c.length,
        d += String.fromCodePoint(c['char']);
      if (b != a) throw new l('Actual string length differs from the specified: ' + (b - a) + ' bytes');
      this.a = b;
      return d
    },
    Xa: function () {
      var a = this.lb();
      return 0 >= a ? null : this.Uc(a -
        1)
    },
    kb: function () {
  ...
  r.zg = function (a, b, c) {
    var d = c;
    if (0 > a) throw new l('Cannot encode UTF8 character: charCode (' + a + ') is negative');
    if (128 > a) b.setUint8(c, a & 127),
      ...
      c += 6;
    else throw new l('Cannot encode UTF8 character: charCode (' + a + ') is too large (>= 0x80000000)');
    return c - d
  };
  r.hg = function (a) {
    if (0 > a) throw new l('Cannot calculate length of UTF8 character: charCode (' + a + ') is negative');
    if (128 > a) return 1;
    if (2048 > a) return 2;
    if (65536 > a) return 3;
    ...
    throw new l('Cannot calculate length of UTF8 character: charCode (' + a + ') is too large (>= 0x80000000)');
  };
  r.xc = function (a) {
    for (var b = 0, c = a.length, d = 0; d < c;) b +=
      r.hg(G.Jf(a, d++));
    return b
  };
  r.ig = function (a) {
  ...
  r.prototype = {
    ...
    Ia: function (a) {
      this.j.byteLength < a && this.Eh(2 * this.j.byteLength >= a ? 2 * this.j.byteLength : a)
    },
    Eh: function (a) {
      if (1 > a) throw new l('Can\'t resize buffer to a capacity lower than 1');
    ...
    fd: function (a) {
      var b = this.a;
      this.Ia(b + r.xc(a));
      for (var c = a.length, d = 0; d < c;) b += r.zg(G.Jf(a, d++), this.j, b);
      this.a = b
    },
    Da: function (a) {
      var b = this.a;
  ...
  V.ci = function (a, b) {
    try {
      ...
      return V.ei(h, m).then(function (a) {
        return window.crypto.subtle.verify(V.Qh, a, e, d)
      }).then(function (a) {
  ...
  Ka.prototype = {
    ni: function (a) {
      for (var b = 0, c = a.cb, d = a.D, e = 0, f = this.list; e < f.length;) {
        var h = f[e];
        ++e;
        var m = h.cb;
        if (m > c) break;
  ...
  ea.prototype = v(va.prototype, {
    ...
    nf: function (a) {
      a.cb == this.ea && a.D <= this.Qa ? (a.D = this.Qa++, a.apply(this.Fa), null != this.wb && this.wb(a)) : this.Md.ni(a)
    },
    h: ea
  });
  Fa.b = !0;
  ...
  Fa.prototype = v(ea.prototype, {
    ...
    Ba: function () {
      var a = ((window.performance.now() - this.yf) * this.re | 0) - this.ea;
      0 < a && this.dg(a);
    ...
    Nh: function (a) {
      ...
      c.Da(this.Qa);
      this.Fa.G(c);
      for (var d = this.Md.list, e = 0, f = d.length; e < f;) this.bf(d[e++], c);
      ...
      V.ci(d, f)['catch'](function () {
        ...
        try {
          if (- 1 != c.Ga.indexOf(b)) {
            ...
            b.R = d;
            c.ub.set(d, b);
            Ea.va(c.lh, d, new C(new DataView(e.buffer, e.byteOffset, e.byteLength), !1));
            b.Wc = !0;
            c.Nh(b)
          }
        } catch (q) {
    ...
    xh: function (a, b) {
      ...
      var d = r.ba();
      d.f(4);
      d.g((window.performance.now() -
        this.yf) * this.re + this.pf);
      d.g(c);
      b.mb(d, 2)
    },
    zh: function (a, b) {
    ...
    h: Ja
  }; Ta.b = !0; x.b = !0; x.prototype = {
    h: x
  }; F.b = !0; F.lf = function (a, b, c, d) {
    return new Promise(function (e, f) {
      var h = new XMLHttpRequest;
      h.open(b, a);
      h.responseType = 'json';
      h.onload = function () {
        200 <= h.status && 300 > h.status ? null != h.response ? e(h.response) : f(null) : f('status: ' + h.status)
      };
      h.onerror = function (a) {
        f(a)
      };
      null != d && h.setRequestHeader('Content-type', d);
      h.send(c)
    })
  }; F.Bg = function (a) {
  ...
  }; ua.b = !0; ua.va = function (a, b) {
    null != a && a(b)
  }; Ea.b = !0; Ea.va = function (a, b, c) {
    null != a && a(b, c)
  }; Ia.b = !0; Ia.va = function (a, b, c, d) {
    null != a && a(b, c, d)
  }; Da.b = !0; Da.va = function (a, b, c, d, e) {
    null != a && a(b, c, d, e)
  }; Ca.b = !0; Ca.prototype = {
    Ef: function (a) {
      null == a && (a = 1);
  ...
  M.b = !0; M.He = function (a) {
    ...
    h: M
  }; ta.b = !0; y.b = !0; y.fh = function () {
    Wa.pi();
    Sa.mi();
    M.Eg().then(function (a) {
      y.Ge = a
    }, function () {
      return {
      }
    ...
    null == y.Vc && (y.Vc = window.document.getElementById('recaptcha'), y.Ch = a.render(y.Vc, {
      sitekey: b,
      callback: function (a) {
        null != y.Kd && y.Kd(a)
      }
    ...
    var q = !m('public', !1),
      ...
      z = m('geo', null),
      x = y.Ge;
    if (null != z && (x = M.He(z), 3 < x.gb.length)) throw new l('Invalid country code');
    var u = new Aa;
    u.Ld = g;
    xa || (g = new ra, g.pa = eb, g.Rb = !0, g.ae = x.gb, u.ca.push(g));
    var A = new Fa({
      iceServers: ta.Ad,
      oi: ta.ye + 'api/host',
      state: u,
    ...
    var C = null,
      D = {
        ...
        getPlayerList: function () {
          for (var a = [
          ], b = 0, c = u.ca; b < c.length;) a.push(f(c[b++]));
          return a
        },
    ...
    A.Rc = function (a) {
      a = y.hh(a, null != A.jb);
      y.Ih.innerHTML = '<p>Room Link: <a href="' + a + '">' + a + '</a></p>';
      var b = D.onRoomLink;
      null != b && b(a)
    };
    console.log('eeee?');
    ...
    u.sh = function (a, c, d, e) {
      ...
      null != h && h(f(a));
      null != c && (h = null, null != e && (h = e.pa), A.yg(a.na, c, h, d), h = D.onPlayerKicked, null != h && h(f(a), c, d, f(e)))
    };
    ...
    Ne: function (a) {
      if (a.ja == p.oa) a.N = null;
        ...
        0 == d.length ? (b.a.x = a.ja.Ee * this.fa.Wb, b.a.y = 0) : (a = b.a, d = d[d.length - 1], a.x = d.x, a.y = d.y);
        d = b.s;
        d.x = 0;
        d.y = 0;
        b = b.ma;
    ...
    Ba: function (a) {
      if (0 < this.Wa) 120 > this.Wa && this.Wa--;
        ...
        for (var b = this.ha.ca, c = 0; c < b.length;) {
          ...
          if (null != d.N) {
            ...
            if (d.yb && 0 >= d.kc && 0 <= d.Sb) {
              ...
              f && (null != this.ha.gf && this.ha.gf(d), d.yb = !1, d.kc = this.ha.Qc, d.Sb -= this.ha.Zb)
            }
            f = d.Hb;
            m = h = 0;
            0 != (f & 1) && --m;
            ...
            0 != (f & 4) && --h;
            0 != (f & 8) && ++h;
            0 != h && 0 != m && (f = Math.sqrt(h * h + m * m), h /= f, m /= f);
            f = d.N.s;
            q = d.yb ? e.Hc : e.oc;
            f.x += h * q;
            f.y += m * q;
        ...
        d = this.ia.w;
        e = 0;
        for (h = d.length; e < h;) f = e++,
          m = d[f],
          0 != (m.m & 128) && (J.Fe[c] = f, f = J.Ve[c], m = m.a, f.x = m.x, f.y = m.y, ++c);
        this.ia.Ba(a);
        if (0 == this.Za) {
          for (a = 0; a < b.length;) c = b[a],
            ++a,
            null != c.N && (c.N.c = 39 | this.Bd.Vg);
          b = this.ia.w[0].s;
          ...
          d = p.oa;
          b = this.ia.w;
          for (a = 0; a < c && (d = a++, d = this.fa.lg(b[J.Fe[d]].a, J.Ve[d]), d == p.oa););
          d != p.oa ? (this.Za = 2, this.xb = 150, this.Bd = d, d == p.ka ? this.Fb++ : this.Mb++, null != this.ha.zf && this.ha.zf(d.Sc), null != this.ha.kf && this.ha.kf(d.R)) : 0 < this.Ma && this.Jb >= 60 * this.Ma && this.Mb != this.Fb && (null != this.ha.Wh && this.ha.Wh(), this.wf())
        } else if (2 == this.Za) this.xb--,
          0 >= this.xb && (0 < this.$a && (this.Mb >= this.$a || this.Fb >= this.$a) || 0 < this.Ma && this.Jb >= 60 * this.Ma && this.Mb != this.Fb ? this.wf() : (this.Oe(), null != this.ha.hf && this.ha.hf()));
        else if (3 ==
          this.Za && (this.xb--, 0 >= this.xb && (b = this.ha, null != b.C))) {
          b.C = null;
          a = 0;
          for (c = b.ca; a < c.length;) d = c[a],
            ++a,
            d.N = null,
            d.Ab = 0;
          null != b.dd && b.dd(null)
    ...
    Oe: function () {
      var a = this.ha.ca;
      this.Za = 0;
      for (var b = this.fa.w, c = this.ia.w, d = 0, e = this.fa.Xc ? b.length : 1; d < e;) {
        var f = d++;
        b[f].Me(c[f])
      }
      b = [
      ...
      for (c = 0; c < a.length;) if (d = a[c], ++c, this.Ne(d), e = d.ja, e != p.oa) {
        var f = d.N.a,
          h = this.fa,
          m = b[e.R],
          q = e == p.ka ? h.Nb : h.Gb;
        0 == q.length ? (q = m + 1 >> 1, 0 == (m & 1) && (q = - q), h = h.La * e.Ee, m = 55 * q) : (m >= q.length && (m = q.length - 1), m = q[m], h = m.x, m = m.y);
        f.x = h;
        f.y = m;
        b[e.R]++;
        d.Ab = b[e.R]
    ...
    if (null != a.trait) {
      ...
      if (null != c) for (var d = 0, e = Za.ji(c); d < e.length;) {
        var f = e[d];
        ++d;
        null == a[f] && (a[f] = c[f])
      }
  ...
  n.Zg = function (a, b) {
    ...
    c.Ac = d;
    c.Bc = e;
    null == m ? (d = b[d], m = b[e], null == d || null == m ? c.Ua = c.Ja = 100 : (e = d.a, m = m.a, d = e.x - m.x, e = e.y - m.y, c.Ua = c.Ja = Math.sqrt(d * d + e * e))) : m instanceof Array && null == m.eb ? (c.Ja = k.l(m[0], t), c.Ua = k.l(m[1], t)) : c.Ua = c.Ja = k.l(m, t);
  ...
  n.ah = function (a) {
    ...
    null != m && (b.Ic = k.l(m, t));
    null != q && (b.Fc = k.l(q, t));
    null != g && (c = b.ma, d = k.l(g[1], t), c.x = k.l(g[0], t), c.y = d);
    null != l && (b.m = n.Ta(l));
    null != p && (b.L = k.l(p, t));
    null != a && (b.Gc = k.l(a, t));
    return b
  ...
  n.prototype = {
    ...
    G: function (a) {
      ...
      if (!this.Tg()) {
        ...
        a.f(this.Nb.length);
        b = 0;
        for (c = this.Nb; b < c.length;) d = c[b],
          ++b,
          a.g(d.x),
          a.g(d.y);
        a.f(this.Gb.length);
        b = 0;
        for (c = this.Gb; b < c.length;) d = c[b],
          ++b,
          a.g(d.x),
          a.g(d.y)
      }
    ...
    Xg: function (a) {
      ...
      var h = e.traits;
      a = e.ballPhysics;
      'disc0' != a && (null != a ? (a = n.Re(a, this.Nc()), a.m |= 192, this.w.push(a)) : this.w.push(this.Nc()));
      ...
      if (2555 < this.u.length || 2555 < this.I.length || 2555 < this.Y.length || 2555 < this.Ra.length || 2555 < this.w.length) throw new l('Error');
      this.Kb()
    },
    lg: function (a, b) {
      for (var c = 0, d = this.Ra; c < d.length;) {
        ...
        var f = e.F,
          ...
          m = b.x - a.x,
          g = b.y - a.y;
        0 < - (f.y - a.y) * m + (f.x - a.x) * g == 0 < - (h.y - a.y) * m + (h.x - a.x) * g ? f = !1 : (m = h.x - f.x, h = h.y - f.y, f = 0 < - (a.y - f.y) * m + (a.x - f.x) * h == 0 < - (b.y - f.y) * m + (b.x - f.x) * h ? !1 : !0);
        if (f) return e.ic
      }
      return p.oa
    },
  ...
  U.prototype = v(g.prototype, {
    ...
    W: function (a) {
      this.Oa = a.kb();
      if (1000 < this.Oa.length) throw new l('message too long');
      this.color = a.H();
      this.style = a.B();
      this.oe = a.B()
    },
  ...
  pa.prototype = v(g.prototype, {
    apply: function (a) {
      if (a.Aa(this.A, 1)) {
        for (var b = a.T(this.A), c = a.ca, d = [
        ], e = 0, f = 0, h = 0; h < c.length;) {
          var g = c[h];
          ++h;
          g.ja == p.oa && d.push(g);
        ...
        c = d.length;
        0 != c && (f == e ? 2 > c || (a.zc(b, d[0], p.ka), a.zc(b, d[1], p.wa)) : a.zc(b, d[0], f > e ? p.ka : p.wa))
      }
    },
    P: function () {
    },
  ...
  L.prototype = v(g.prototype, {
    apply: function (a) {
      if (a.Aa(this.A, 2) && null == a.C) switch (this.ne) {
        case 0:
          var b = this.newValue;
          a.$a = 0 > b ? 0 : 99 < b ? 99 : b;
          break;
    ...
    h: L
  }); T.b = !0; T.V = function (a, b) {
    var c = new T;
    c.Bb = a;
    c.kd = b;
    return c
  }; T.M = g; T.prototype = v(g.prototype, {
    apply: function (a) {
      if (a.Aa(this.A, 4)) {
        var b = a.T(this.A),
          c = a.T(this.Bb);
        null != c && 0 != c.na && c.Rb != this.kd && (c.Rb = this.kd, null != a.df && a.df(b, c))
      }
    },
    P: function (a) {
      a.v(this.Bb);
    ...
    h: T
  }); oa.b = !0; oa.M = g; oa.prototype = v(g.prototype, {
    apply: function (a) {
      a = a.T(this.A);
      null != a && (a.zb = this.Ea)
    },
    ...
    h: oa
  }); S.b = !0; S.V = function (a, b) {
    var c = new S;
    c.Bb = a;
    c.he = b;
    return c
  }; S.M = g; S.prototype = v(g.prototype, {
    apply: function (a) {
      var b = a.T(this.Bb);
      if (null != b) {
        var c = a.T(this.A),
    ...
    h: S
  }); K.b = !0; K.V = function (a) {
    var b = new K;
    b.md = a;
    return b
  }; K.M = g; K.prototype = v(g.prototype, {
    apply: function (a) {
      if (a.Aa(this.A, 8)) {
        var b = a.T(this.A);
    ...
    W: function (a) {
      ...
      this.md = n.qa(new C(new DataView(a.buffer, a.byteOffset, a.byteLength)))
    },
    h: K
  }); da.b = !0; da.M = g; da.prototype = v(g.prototype, {
    apply: function (a) {
    ...
    h: da
  }); ca.b = !0; ca.M = g; ca.prototype = v(g.prototype, {
    apply: function (a) {
  ...
  R.M = g; R.prototype = v(g.prototype, {
    ...
    h: R
  }); Q.b = !0; Q.V = function (a, b) {
    var c = new Q;
    c.Ea = null != b ? H.pb(b, 2) : null;
    c.rb = a;
    return c
  }; Q.M = g; Q.prototype = v(g.prototype, {
    apply: function (a) {
      a = a.T(this.rb);
    ...
    h: Q
  }); ba.b = !0; ba.M = g; ba.prototype = v(g.prototype, {
    apply: function (a) {
      var b = a.C;
    ...
    h: ba
  }); aa.b = !0; aa.M = g; aa.prototype = v(g.prototype, {
    Rf: function (a) {
      if (null != a.ef) {
        var b = a.T(this.A);
    ...
    h: aa
  }); na.b = !0; na.M = g; na.prototype = v(g.prototype, {
    apply: function (a) {
      var b = a.T(this.A);
      if (null != b) {
        var c = this.input;
    ...
    h: na
  }); ma.b = !0; ma.M = g; ma.prototype = v(g.prototype, {
    apply: function (a) {
      var b = a.T(this.A);
    ...
    g.aa(Q);
    g.aa(E)
  }; I.b = !0; I.V = function (a, b, c) {
    var d = new I;
    d.na = a;
    d.qb = b;
    d.gd = c;
    return d
  }; I.M = g; I.prototype = v(g.prototype, {
    apply: function (a) {
    ...
    W: function (a) {
      ...
      this.qb = a.Xa();
      this.gd = 0 != a.B();
      if (null != this.qb && 100 < this.qb.length) throw new l('string too long');
    },
    h: I
  }); P.b = !0; P.V = function (a, b) {
    ...
    c.ie = b;
    return c
  }; P.M = g; P.prototype = v(g.prototype, {
    apply: function (a) {
      if (0 == this.A) {
    ...
    a = 0;
    for (b = d.za.length; a < b;) c = a++,
      e = d.za[c],
      null != e && (E.Of[0] = e, d.za[c] = E.Of[0]);
    return d
  }; E.M = g; E.prototype = v(g.prototype, {
    apply: function (a) {
      if (0 == this.A) {
        var b = a.C;
        if (null != b) {
          ...
          null != a && (null != this.O[0] && (a.a.x = this.O[0]), null != this.O[1] && (a.a.y = this.O[1]), null != this.O[2] && (a.s.x = this.O[2]), null != this.O[3] && (a.s.y = this.O[3]), null != this.O[4] && (a.ma.x = this.O[4]), null != this.O[5] && (a.ma.y = this.O[5]), null != this.O[6] && (a.L = this.O[6]), null != this.O[7] && (a.i = this.O[7]), null != this.O[8] && (a.K = this.O[8]), null != this.O[9] && (a.ga = this.O[9]), null != this.za[0] && (a.S = this.za[0]), null != this.za[1] && (a.c = this.za[1]), null != this.za[2] && (a.m = this.za[2]))
        }
      }
    },
    P: function (a) {
      ...
      e = 0;
      for (f = this.za; e < f.length;) h = f[e],
        ++e,
        null != h && (c |= d, a.v(h)),
        d <<= 1;
      d = a.a;
    ...
    h: E
  }); O.b = !0; O.V = function (a, b, c) {
    var d = new O;
    d.min = a;
    d.le = b;
    d.$d = c;
    return d
  }; O.M = g; O.prototype = v(g.prototype, {
    apply: function (a) {
  ...
  Z.b = !0; Z.M = g; Z.prototype = v(g.prototype, {
    apply: function (a) {
    ...
    h: Z
  }); Y.b = !0; Y.M = g; Y.prototype = v(g.prototype, {
    apply: function (a) {
      if (a.Aa(this.A, 32)) {
        var b = a.T(this.A);
        if (null != a.C) {
    ...
    h: Y
  }); N.b = !0; N.V = function (a) {
    for (var b = new N, c = a.Fa.ca, d = [
    ], e = 0; e < c.length;) {
  ...
  N.M = g; N.prototype = v(g.prototype, {
    apply: function (a) {
      if (0 == this.A) {
        a = a.ca;
    ...
    ng: function (a) {
      ...
      if (0 < f && f <= e * e) {
        ...
        0 > e && (e *= this.i * a.i + 1, c *= e, h = f = this.s, f.x = h.x - d * c, f.y = h.y - b * c, a = f = a.s, c = e - c, f.x = a.x + d * c, f.y = a.y + b * c)
      }
    },
    og: function (a) {
      var b,
      ...
      if (0 != 0 * a.Ha) {
        ...
        e = h.y - e.y;
        h = this.a;
        if (0 >= (h.x - b.x) * c + (h.y - b.y) * f || 0 <= d * c + e * f) return;
        c = a.X;
        b = c.x;
        c = c.y;
        d = b * d + c * e
        ...
        d = a.bd;
        e = a.cd;
        if ((0 < d.x * b + d.y * c && 0 < e.x * b + e.y * c) == 0 >= a.Ha) return;
        e = Math.sqrt(b * b + c * c);
        if (0 == e) return;
        d = e - a.Ce;
        b /= e;
      ...
      d >= this.L || (d = this.L - d, f = e = this.a, e.x = f.x + b * d, e.y = f.y + c * d, d = this.s, d = b * d.x + c * d.y, 0 > d && (d *= this.i * a.i + 1, e = a = this.s, a.x = e.x - b * d, a.y = e.y - c * d))
    },
    h: la
  };
  ka.b = !0; ka.Eb = [
    ...
    Ba: function (a) {
      ...
      if (null != b && null != a) {
        ...
        if (!(0 >= f)) {
          ...
          var h,
            g;
          if (this.Ja >= this.Ua) h = this.Ja,
            g = 0;
          else if (f <= this.Ja) h = this.Ja,
            g = 1;
          else if (f >= this.Ua) h = this.Ua,
            g = - 1;
          else return;
          f = h - f;
          if (0 == 0 * this.hc) d = this.hc * f * 0.5,
            e *= d,
            c *= d,
            g = d = b.s,
            b = b.K,
            ...
            0 >= f * g && (d *= f, b = g = b.s, g.x = b.x - e * d, g.y = b.y - c * d, a = b = a.s, d = f - d, b.x = a.x + e * d, b.y = a.y + c * d)
          }
        }
      }
    },
    ...
    Ba: function (a) {
      ...
      for (b = this.w.length; a < b;) {
        ...
        c = this.w[d];
        d += 1;
        for (e = this.w.length; d < e;) f = this.w[d++],
          0 != (f.c & c.m) && 0 != (f.m & c.c) && c.ng(f);
        if (0 != c.K) {
          d = 0;
          for (e = this.Y; d < e.length;) if (f = e[d], ++d, 0 != (f.c & c.m) && 0 != (f.m & c.c)) {
            var h = f.X,
              g = c.a,
            ...
            if (0 < h) {
              ...
              g = f.X;
              h = h.x * g.x + h.y * g.y;
              0 > h && (h *= c.i * f.i + 1, k = g = c.s, f = f.X, g.x = k.x - f.x * h, g.y = k.y - f.y * h)
            }
          }
          d = 0;
          for (e = this.I; d < e.length;) f = e[d],
            ++d,
            0 != (f.c & c.m) && 0 != (f.m & c.c) && c.og(f);
          d = 0;
          for (e = this.u; d < e.length;) if (f = e[d], ++d, 0 != (f.c & c.m) && 0 != (f.m & c.c) && (g = c.a, k = f.a, h = g.x - k.x, g = g.y - k.y, k = h * h + g * g, 0 < k && k <= c.L * c.L)) {
            var k = Math.sqrt(k),
              h = h / k,
              g = g / k,
              k = c.L - k,
            ...
            k = c.s;
            k = h * k.x + g * k.y;
            0 > k && (k *= c.i * f.i + 1, l = f = c.s, f.x = l.x - h * k, f.y = l.y - g * k)
          }
        }
      }
      for (a = 0; 2 > a;) for (++a, b = 0, c = this.Sa; b < c.length;) c[b++].Ba(this.w)
    },
    h: za
  };
  B.b = !0; B.prototype = {
    ...
    Kb: function () {
      if (0 == 0 * this.Ha) {
        ...
        0 >= this.Ha && (a = c = this.bd, c.x = - a.x, c.y = - a.y, a = c = this.cd, c.x = - a.x, c.y = - a.y)
      } else a = this.F.a,
        b = this.J.a,
        c = a.x - b.x,
        a = - (a.y - b.y),
    ...
    h: w
  }; l.b = !0; l.vi = function (a) {
    return a instanceof Error ? a : new l(a)
  }; l.M = Error; l.prototype = v(Error.prototype, {
    h: l
  }); k.b = !0; k.Mf = function (a) {
    ...
    switch (c) {
      ...
      case 'object':
        ...
        for (c in a) f && !a.hasOwnProperty(c) || 'prototype' == c || '__class__' == c || '__super__' == c || '__interfaces__' ==
  ...
  k.Zf = function (a, b) {
    ...
    switch (b) {
      ...
      default:
        ...
        return b == gb && null != a.b || b == hb && null != a.se ? !0 : Oa[a.eb] == b
    }
  };
  k.l = function (a, b) {
  ...
  k.te = function (a) {
    ...
    return 'Object' == a || 'Function' == a || 'Math' == a || 'JSON' ==
      a ? null : a
  };
  k.$f = function (a) {
    return null != k.te(a)
  ...
  null == ArrayBuffer.prototype.slice && (ArrayBuffer.prototype.slice = Ra.ri);
  wa.qg = {
    mandatory: {
